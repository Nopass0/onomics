...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 " data-mode=''>
        <div className="px-4 lg:px-40 py-6 backdrop-blur-[2px] bg-opacity-20 max-sm:hidden flex justify-between font-light text-primary-dark dark:text-primary bg-primary dark:bg-primary-dark">
