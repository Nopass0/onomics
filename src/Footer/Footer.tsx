...
const Footer: React.FC = () => {
  return (
    <footer className="lg:text-left max-w-full  backdrop-blur-xl bg-white dark:bg-black">
      <div className="flex items-center justify-center border-b-[2px] border-[#121212] bg-opacity-60 p-6 lg:justify-between"></div>

      <div className="lg:flex lg:justify-center mx-auto py-10 md:text-left max-w-full max-lg:ml-8">
        <div className="grid-1 grid gap-10 lg:gap-44 max-md:grid-cols-1 lg:grid-cols-3">
          <div className="text-sm">
            ...
            <p className="mt-5 mb-2">Мы всегда готовы ответить на ваши вопросы!</p>
            <a href="#!">Задать вопрос</a>
          </div>
          <div className="uppercase text-sm">
            <h6 className="mb-4 flex font-semibold uppercase md:justify-start">Информация</h6>
            <p className="mb-4">
          ...
          <div className="text-sm">
            ...
            <p className="mb-4 flex items-center md:justify-start">
              <a href="" className="mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="#ffffff" className="w-8 h-8" viewBox="0 0 50 50">
              ...
              <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-telegram w-8 h-7" viewBox="0 0 16 16">
