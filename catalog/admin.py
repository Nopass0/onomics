...
admin.site.register(Comic, list_display=['title', 'description', 'image', 'price', 'slug', 'rating'], list_filter=['genres', 'tags'], search_fields=['title', 'description'])
...
admin.site.register(Comment, list_display=['text', 'author_id', 'date'], search_fields=['text'])
