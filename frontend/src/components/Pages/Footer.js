        ...
        <div className="grid-1 grid gap-10 lg:gap-44 max-md:grid-cols-1 lg:grid-cols-3">
          <div className="text-sm">
            <h6 className="mb-4 flex items-center  font-semibold uppercase md:justify-start">
              <img src={logo.url} alt="Logo" className="w-8 h-8 mr-3"/>
              Onomics
            </h6>
            <p className="">
              Читать комиксы онлайн на русском!
            </p>
          ...
          <div className="uppercase text-sm">
            ...
            <p className="mb-4">
              <a href="#!" className="text-white">Агентский договор</a>
            </p>
            <p className="mb-4">
              <a href="" className="text-white">Соглашение о конфиденциальности</a>
            </p>
            <p>
          ...
          <div className="text-sm">
            ...
            <p className="mb-4 flex items-center md:justify-start">
              <a href="" className="mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="#ffffff" className="w-8 h-8"
                  viewBox="0 0 50 50">
                  <path
              ...
              <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-telegram w-8 h-7"
                  viewBox="0 0 16 16">
                  <path
